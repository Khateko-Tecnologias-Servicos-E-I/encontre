...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/presentation.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/gamepad.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/atomic.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                            <h4>Mix &amp; Match</h4>
                            <p>Etiam nec odio vestibulum est mat tis effic iturut magna.</p>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/safebox.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/settings-2.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-feature-area d-flex mb-100">
                        <div class="feature-icon mr-30">
                            <img src="{{ asset('assets/img/front-end/core-img/alarm-clock.png') }}" alt="">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="testimonials-slides owl-carousel">
                        ...
                        <div class="single-testimonial-area text-center">
                            ...
                            <div class="testimonials-meta">
                                <div class="testimonial-thumb bg-img" style="background-image: url({{ asset('assets/img/front-end/bg-img/c-1.jpg') }});"></div>
                                <h6>Jim Morison</h6>
                                <p>Company CEO</p>
                            </div>
                        </div>
                        ...
                        <div class="single-testimonial-area text-center">
                            ...
                            <!-- Testimonial Meta Data -->
                            <div class="testimonials-meta">
                                <div class="testimonial-thumb bg-img" style="background-image: url({{ asset('assets/img/front-end/bg-img/c-2.jpg') }});"></div>
                                <h6>Jim Morison</h6>
                                <p>Company CEO</p>
                            </div>
                        </div>
                        ...
                        <div class="single-testimonial-area text-center">
                            ...
                            <!-- Testimonial Meta Data -->
                            <div class="testimonials-meta">
                                <div class="testimonial-thumb bg-img" style="background-image: url({{ asset('assets/img/front-end/bg-img/c-3.jpg') }});"></div>
                                <h6>Jim Morison</h6>
                                <p>Company CEO</p>
                            </div>
                        </div>
    ...
    <section class="mosh-cool-facts-area service-page bg-img section_padding_100" style="background-image: url({{ asset('assets/img/front-end/core-img/breadcumb.png') }});">
        <div class="container">
            <div class="row">
                <!-- Single Cool Fact-->
    ...
    <section class="mosh-subscribe-newsletter-area bg-img bg-overlay-white section_padding_100" style="background-image: url({{ asset('assets/img/front-end/bg-img/sub-1.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-12">
