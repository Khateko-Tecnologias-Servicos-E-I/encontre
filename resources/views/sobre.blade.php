...
@section('content')
                    ...
                    <div class="bradcumbContent">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tudo sobre Encontre</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="mosh-about-us-thumb wow fadeInUp" data-wow-delay="0.5s">
                        <img src="{{ asset('assets/img/front-end/bg-img/headpiece.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="mosh-features-thumb wow fadeIn" data-wow-delay="0.5s">
                        <img src="{{ asset('assets/img/front-end/bg-img/features-2.png') }}" alt="">
                    </div>
                </div>
                    ...
                    <div class="mosh-about-us-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-feature-area d-flex">
                                    <div class="feature-icon mr-30">
                                        <img src="{{ asset('assets/img/front-end/core-img/photo-camera.png') }}" alt="">
                                    </div>
                                    <div class="feature-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-feature-area d-flex">
                                    <div class="feature-icon mr-30">
                                        <img src="{{ asset('assets/img/front-end/core-img/like.png') }}" alt="">
                                    </div>
                                    <div class="feature-content">
                                        <h5>30k Followers</h5>
                                        <p>Etiam nec odio vestibulum est mat tis effic iturut magna.</p>
    ...
    <section class="few-words-from-ceo d-md-flex">
                    ...
                    <div class="col-12 col-md-11 col-lg-9 col-xl-7">
                        <div class="few-words-text">
                            ...
                            <div class="ceo-meta-data d-flex align-items-center mt-50">
                                <div class="ceo-thumb bg-img" style="background-image: url({{ asset('assets/img/front-end/bg-img/ceo.png') }});"></div>
                                <div class="ceo-name">
                                    <h6>Jim Morison</h6>
                                    <p>Company CEO</p>
                                </div>
        ...
        <div class="few-words-thumb bg-img wow fadeInRightBig" data-wow-delay="1.1s" style="background-image: url({{ asset('assets/img/front-end/bg-img/cta-2.png') }});"></div>
    </section>
    <!-- ***** Few Words Area End ***** -->
                    ...
                    <div class="mosh-team-slides owl-carousel">
                        ...
                        <div class="single-team-slide text-center">
                            ...
                            <div class="team-thumbnail">
                                <img src="{{ asset('assets/img/front-end/bg-img/c-1.jpg') }}" alt="">
                            </div>
                            <!-- Meta Info -->
                        ...
                        <div class="single-team-slide text-center">
                            <!-- Thumbnail -->
                            <div class="team-thumbnail">
                                <img src="{{ asset('assets/img/front-end/bg-img/c-2.jpg') }}" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
                        ...
                        <div class="single-team-slide text-center">
                            <!-- Thumbnail -->
                            <div class="team-thumbnail">
                                <img src="{{ asset('assets/img/front-end/bg-img/c-3.jpg') }}" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
